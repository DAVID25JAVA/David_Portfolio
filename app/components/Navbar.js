...
import { Menu, X, Sun, Moon, ArrowRight, Home, User, Briefcase, MessageCircle } from "lucide-react";
...
function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Sidebar */}
      <div className={`fixed top-0 right-0 h-full w-80 bg-white/95 backdrop-blur-xl shadow-2xl z-50 transform transition-transform duration-300 ease-out md:hidden ${
