      ...
      <div className="max-w-6xl mx-auto w-full relative z-10">
        ...
        <div className="flex flex-col justify-center items-center mx-auto gap-8">
          ...
          <div className="relative group">
            <div
              className={`absolute -inset-4 rounded-full blur opacity-30 group-hover:opacity-50 transition duration-1000 animate-pulse ${
                isDark
                  ? "bg-linear-to-r from-blue-500/40 via-indigo-500/40 to-violet-500/40"
                  : "bg-linear-to-r from-blue-600 via-purple-600 to-indigo-600"
              }`}
            ></div>
            <div className="relative">
              <div
                className={`w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden shadow-2xl transform group-hover:scale-105 transition duration-500 ${
          ...
          {/* Greeting Section */}
          <div
            className={`flex justify-center items-center gap-3 backdrop-blur-md rounded-2xl px-6 py-3 shadow-lg transition-colors duration-500 ${
              isDark
          ...
          <div className="text-center space-y-2">
            <h1
              className={`text-4xl md:text-6xl font-bold animate-slide-horizontal leading-tight transition-colors duration-500 ${
          ...
          <div className="max-w-4xl text-center">
            <p
              className={`text-lg md:text-xl leading-relaxed backdrop-blur-md rounded-2xl p-6 shadow-lg transition-colors duration-500 ${
                isDark
            ...
            >
              ...
              <span
                className={`font-bold bg-linear-to-r bg-clip-text text-transparent ${
                  isDark
                    ? "from-blue-400 to-indigo-400"
                    : "from-blue-600 to-indigo-600"
                }`}
          ...
          <div className="flex flex-wrap justify-center gap-3 max-w-2xl">
            {data.map((social) => (
              <div key={social?._id} className="flex gap-5 cursor-pointer">
                <a href={social?.linkedIn} target="_blank">
                  <button className="bg-linear-to-r cursor-pointer from-blue-600 to-indigo-600 text-white px-5 py-2 rounded-full">
                    LinkedIn
                  </button>
                </a>
                <a href={social?.github} target="_blank">
                  <button className="bg-linear-to-r cursor-pointer from-gray-700 to-gray-700 text-white px-5 py-2 rounded-full">
                    GitHub
                  </button>
                </a>
              </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 mt-4">
            ...
            >
              <div className="flex items-center gap-3">
                <a target="_blank" href={data[0]?.resume}>
                  <span>My Resume</span>
                </a>
          ...
          {/* Status Indicator */}
          <div
            className={`flex items-center mb-5 gap-3 backdrop-blur-md rounded-full px-4 py-2 shadow-lg transition-colors duration-500 ${
              isDark
