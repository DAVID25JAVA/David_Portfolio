...
const AboutSection = () => {
  const skills = [
    ...
    'Express', 'MongoDB', 'Git & Github', 'BitBucket'
  ];
          ...
          <div className="w-full lg:w-full space-y-8">
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                ...
                contributing to their success and growth through innovative web solutions and cutting-edge technologies.
              </p>
            </div>
              ...
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20 hover:transform hover:scale-105 transition duration-300">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900">Master of Computer Applications</h4>
